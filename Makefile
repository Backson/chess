...
SOURCES=Action.cpp Board.cpp Bot.cpp compare.cpp Game.cpp main.cpp MoveCache.cpp Piece.cpp PieceSelector.cpp Position.cpp RandomBot.cpp Rules.cpp Situation.cpp SpeedyBot.cpp vec.cpp View.cpp
