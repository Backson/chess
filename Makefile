...
SOURCES=Action.cpp Board.cpp compare.cpp Game.cpp main.cpp Piece.cpp Position.cpp Rules.cpp Situation.cpp vec.cpp View.cpp Bot.cpp RandomBot.cpp SpeedyBot.cpp zobrist.cpp
